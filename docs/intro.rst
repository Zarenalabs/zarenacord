...
This is the documentation for zarenacord, a library for Python to aid
in creating applications that utilise the Discord API.

Prerequisites
---------------

zarenacord works with Python 3.8 or higher. Support for earlier versions of Python
...
To get voice support, you should use ``zarenacord[voice]`` instead of ``zarenacord``, e.g. ::
...
zarenacord revolves around the concept of :ref:`events <discord-api-events>`.
